...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      + "</label>"
      + "<p>Alternar el estado de la barra lateral izquierda (abierta o cerrada)</p>"
      + "</div>"
      ...
      + "</label>"
      + "<p>Ampliar la mini-barra lateral</p>"
      + "</div>"
        //Control Sidebar Toggle
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
      + "<input type='checkbox' data-controlsidebar='control-sidebar-open' class='pull-right'/> "
      + "Activar la barra lateral derecha"
      + "</label>"
      + "<p>Alternar el estado de la barra lateral derecha (abierta o cerrada)</p>"
      + "</div>"
      ...
      + "Skin"
      + "</label>"
      + "<p>Cambiar de Skin a la barra lateral derecha a oscuro o claro</p>"
      + "</div>"
  );
  ...
  var skin_purple_light =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "<div><span style='display:block; width: 20%; float: left; height: 20px; background: #f9fafc;'></span><span style='display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;'></span></div>"
          + "</a>"
          + "<p class='text-center no-margin' style='font-size: 12px'>Púrpura - Blanco</p>");
