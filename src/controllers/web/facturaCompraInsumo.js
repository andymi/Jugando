  ...
  mensaje.retriveCount(function (mensaje1) { 
    ...
    if (mensaje1) {     
      mensaje.retrieveAll(function (mensaje2) {
        ...
        if (mensaje2) {  
          proveedor.retrieveByProveedor2(function (proveedorQ) {
            console.log('proveedorQ',proveedorQ);
            if (proveedorQ) {
                res.render('web/facturaCompraInsumo/index', {
      ...
      mensaje.retrieveAll(function (mensaje2) {
        ...
        if (mensaje2) { 
          facturaCompra.retrieveAll(function (facturaCompra) {
            if (facturaCompra) {      
              res.render('web/facturaCompraInsumo/success', { 
  ...
  mensaje.retriveCount(function (mensaje1) { 
    ...
    if (mensaje1) {     
      mensaje.retrieveAll(function (mensaje2) {
        console.log('mensaje2', mensaje2);
        if (mensaje2) { 
          proveedor.retrieveAll2(function (proveedor) {
            if (proveedor) {
              facturaCompra.retrieveById(req.params.facturaCompraId, function (facturaCompra) {
                if (facturaCompra) {
                  res.render('web/facturaCompraInsumo/edit', {
                              facturaCompra:facturaCompra,
                              select: proveedor,
                              mensajes: mensaje1,
                              mensajeria: mensaje2
